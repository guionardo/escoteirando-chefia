<template>
    <q-card class="login-card" bordered>
        ...
        <q-form ref="login_form">
            <q-card-section>
                <q-input v-model="username" autofocus label="Usuário" :rules="[(val) => !!val || 'Usuário é requerido']">
...
import {ILoginRequest} from 'src/domain/models/interfaces'
@Component
export default class LoginComponent extends Vue {
    ...
    doLogin(): void {
        ...
        this.logger.logDebug('Calling mappaStore.login', { username: this.username, password: this.password })
        const loginRequest: ILoginRequest = {
            username: this.username,
            password: this.password
        }
        if (mappaStore.login(loginRequest)) {
