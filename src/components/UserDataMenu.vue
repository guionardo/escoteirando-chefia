        ...
        <q-menu>
            <div class="row no-wrap q-pa-md">
                ...
                <div class="column items-center">
                    ...
                    <q-separator />
                    <q-btn class="q-mt-md full-width" icon="gavel" align="between" color="secondary" label="Termos de Uso" size="sm" to="usage_terms" />
                    <q-btn class="q-mt-md full-width" icon="logout" align="between" color="primary" label="Sair" size="sm" v-close-popup @click="logout" />
                </div>
            </div>
        </q-menu>
    </q-btn>
